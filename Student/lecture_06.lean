...
--why #reduce: eval is for built in data types use reduce 
--for own dtypes/functs
#reduce play scissors paper
end RPS
...
--Learn about pattern matching: pattern matches binds names to objects within datastructures
...
/- intruce new data type call prod Nat Bool gives type 
type to type 
-/
